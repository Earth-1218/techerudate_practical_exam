...
6. Install the frontend dependencies with `npm install`.
7. Compile the frontend assets with `npm run dev`.
...
After running the database seed, the application will have two default users:
